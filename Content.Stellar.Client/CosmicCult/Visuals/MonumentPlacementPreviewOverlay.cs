...
public sealed class MonumentPlacementPreviewOverlay : Overlay
{
    ...
    public MonumentPlacementPreviewOverlay(IEntityManager entityManager, IPlayerManager playerManager, IPrototypeManager protoMan, IGameTiming timing, int tier)
    {
        ...
        _mainTex = new SpriteSpecifier.Rsi(new ResPath("_ST/CosmicCult/Tileset/monument.rsi"), $"stage{tier}");
        _outlineTex = new SpriteSpecifier.Rsi(new ResPath("_ST/CosmicCult/Tileset/monument.rsi"), $"stage{tier}-placement-ghost-1");
        _starTex = new SpriteSpecifier.Rsi(new ResPath("_ST/CosmicCult/Tileset/monument.rsi"), $"stage{tier}-placement-ghost-2");
    }
